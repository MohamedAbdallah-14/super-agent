---
name: sa:subagent-driven-development
...
digraph process {
    ...
    "Use sa:finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Use sa:finishing-a-development-branch";
}
```
